<?php $title = "Правка товара"; require_once "header.php"; ?>
...
<?php			
        ...
        print "<tr><td>Свойства</td><td><input name='properties' value='".$row['Свойства']."' maxlength=60 size=30></td></tr>";
